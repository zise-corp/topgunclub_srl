...
const FIREARMS = [
  {
    category: 'Pistolas',
    items: [
      { name: 'Phoenix Arms HP22A', brand: 'PHOENIXARMS', price: 805, specs: { caliber: '.22 LR', type: 'Semiautomática' } },
      { name: 'Sarsilmaz B6C9', brand: 'SARSILMAZ', price: 1350, specs: { caliber: '9mm', type: 'Semiautomática' } },
      { name: 'Walther P22Q', brand: 'WALTHER', price: 1945, specs: { caliber: '.22 LR', type: 'Semiautomática' } },
      { name: 'Smith & Wesson M&P Compact', brand: 'SMITH & WESSON', price: 1945, specs: { caliber: '9mm', type: 'Compacta' } },
      { name: 'Ruger M&P Compact', brand: 'RUGER', price: 1945, specs: { caliber: '9mm', type: 'Compacta' } },
      { name: 'HS Produkt SF19', brand: 'HS PRODUKT', price: 2335, specs: { caliber: '9mm', barrel: '4.5"' } },
    ]
  },
  {
    category: 'Rifles',
    items: [
      { name: 'Rossi Gallery BK', brand: 'ROSSI', price: 910, specs: { caliber: '.22 LR', type: 'Corredera' } },
      { name: 'Rossi Gallery Wood', brand: 'ROSSI', price: 990, specs: { caliber: '.22 LR', type: 'Corredera' } },
      { name: 'Rossi Rio Bravo', brand: 'ROSSI', price: 1155, specs: { caliber: '.22 LR', type: 'Palanca' } },
      { name: 'Rossi Rio Bravo Gold', brand: 'ROSSI', price: 1355, specs: { caliber: '.22 LR', type: 'Palanca' } },
      { name: 'Rossi Rio Bravo Gold Mate', brand: 'ROSSI', price: 1555, specs: { caliber: '.22 LR', type: 'Palanca' } },
      { name: 'Mendoza Squad', brand: 'MENDOZA', price: 1015, specs: { type: 'Varilla', model: '1911' } },
      { name: 'Kriss DMK22C FDE', brand: 'KRISS USA', price: 2640, specs: { caliber: '.22 LR' } },
      { name: 'Kriss DMK22C BK', brand: 'KRISS USA', price: 2420, specs: { caliber: '.22 LR' } },
      { name: 'CZ Training', brand: 'CZ', price: 2640, specs: { caliber: '.22 LR' } },
    ]
  },
  {
    category: 'Escopetas',
    items: [
      { name: 'Boito Miuras SB', brand: 'BOITO', price: 630, specs: { caliber: '12', type: '2 tiros' } },
      { name: 'Boito Miura Supreme', brand: 'BOITO', price: 1540, specs: { caliber: '12' } },
      { name: 'Boito Miura Special', brand: 'BOITO', price: 1400, specs: { caliber: '12' } },
      { name: 'Uzkon T17/T16', brand: 'UZKON', price: 715, specs: { caliber: '12' } },
      { name: 'Taurus ST12', brand: 'TAURUS', price: 1320, specs: { caliber: '12' } },
      { name: 'Hatsan Escort AS9', brand: 'HATSAN', price: 1045, specs: { caliber: '12' } },
      { name: 'Hatsan Escort Luxano', brand: 'HATSAN', price: 1540, specs: { caliber: '12' } },
      { name: 'Hatsan Escort Supreme', brand: 'HATSAN', price: 1320, specs: { caliber: '12' } },
      { name: 'Hatsan Escort Supreme Max', brand: 'HATSAN', price: 1485, specs: { caliber: '12' } },
    ]
  }
];
            ...
            <div key={section.category} className="reveal" data-d={(sectionIdx % 2) + 1} style={{ marginBottom: '60px', marginTop: sectionIdx > 0 ? '40px' : '0' }}>
              ...
              <div className="grid cols-3">
                {section.items.map((item, i) => (
                  <div key={i} className="card" style={{ padding: '24px', border: '1px solid var(--line)', borderRadius: 'var(--r)' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 'auto', paddingTop: '16px', borderTop: '2px solid var(--green-deep)' }}>
          ...
          {PCP_WEAPONS.map((section, sectionIdx) => (
            <div key={section.category} className="reveal" data-d={(sectionIdx % 2) + 1} style={{ marginBottom: '60px', marginTop: sectionIdx > 0 ? '40px' : '0' }}>
              ...
              <div className="grid cols-2" style={{ gap: '24px' }}>
                {section.items.map((item, i) => (
                  <div key={i} className="card" style={{ padding: '28px', border: '1px solid var(--line)', borderRadius: 'var(--r)' }}>
